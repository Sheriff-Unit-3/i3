...
![luacheck](https://github.com/mt-historical/i3/actions/workflows/luacheck.yml/badge.svg)
[![ContentDB](https://content.luanti.org/packages/mt-mods/i3/shields/downloads/)](https://content.luanti.org/packages/mt-mods/i3/)

## **`i3`** is a next-generation inventory for Luanti/Minetest
...
This mod requires **Luanti/Minetest v5.10+**
...
`i3` uses a larger inventory than the usual inventories in Luanti/Minetest games.
